...
function setup() {
	...
	wall1= Bodies.rectangle(width/2, 640, 200, 20,{ isStatic: true});
	wall1.shapeColor=color("red");
	World.add(world, wall1)
	
	wall2= Bodies.rectangle(width/3, 620, 20, 100,{ isStatic: true});
	wall2.shapeColor=color("red");
	World.add(world, wall2)
	
	wall3= Bodies.rectangle(width/1.5, 620, 20, 100,{ isStatic: true});
